...
* Notice that the temperature at 600m is no longer significant compared to the previous data  
...
* The 2D smoother is fitting the spatial variation not explained by the other predictors  
```{r}
...
```{r echo=FALSE}
par(mar=c(4,4,3,3),mfrow = c(2,2))
plot(twS999LL, pages = 4, residuals = FALSE, pch = 20, cex = 0.25,
...
trainS999$predicted <- predict(twS999LLb, data = testS999)
```
```{r eval=FALSE}
