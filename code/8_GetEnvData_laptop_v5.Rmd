...
sw <- readRDS(here::here('output', 'centroids1303_10km.rda'))
...
saveRDS(env5_bath, here::here('output/data_output', '1303_10km_bath.rda'))
...
env5_bath=tmp
saveRDS(env5_bath, here::here('output/data_output', '1303_10km_bathsub.rda'))
...
saveRDS(env4_ww3, here::here('output/data_output', '1303_10km_wavepow.rda'))
