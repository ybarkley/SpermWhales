...
SwEnvData_tot <- read.csv('./output/SpermiesFinalLR_20200708.csv', stringsAsFactors = FALSE)
surveynum = 1303
...
write.csv(str8eff, here::here('output', paste0('straightPathWeffort_', survey, 'b.csv')), row.names = FALSE)
```
