...
sw=readRDS(here::here(paste0('Documents\\PHD\\Chp 3\\data\\centroids\\', gridsize, ' km'), paste0('centroids', surveynum, '_', gridsize, 'km_trk.rda'))) #using NOAA laptop
...
# sshZtidya <-readRDS('C:\\Users\\yvers\\Documents\\CHP 3\\SpermWhales/data/sshsd_tidy.rda') #desktop
...
#### SAVE All bathy data ####
saveRDS(env5_bath, here::here(paste0('Documents\\PHD\\Chp 3\\',surveynum, '_', gridsize, 'km_', loctype2, '_bathyAll.rda')))
...
saveRDS(env5_bath, here::here(paste0('Documents\\PHD\\Chp 3\\',surveynum, '_', gridsize, 'km_', loctype2, '_bathy.rda')))
...
#### SAVE d2land ####
saveRDS(env8_d2land, here::here(paste0('Documents\\PHD\\Chp 3\\',surveynum, '_', gridsize, 'km_', loctype2, '_d2land.rda')))
...
#### SAVE temp600 ####
saveRDS(env3_godas600, here::here(paste0('Documents\\PHD\\Chp 3\\',surveynum, '_', gridsize, 'km_', loctype2, '_temp600.rda')))
...
#### SAVE wavepow ####
saveRDS(env4_ww3, here::here(paste0('Documents\\PHD\\Chp 3\\',surveynum, '_', gridsize, 'km_', loctype2, '_wavepow.rda')))
...
#### SAVE slpasp ####
saveRDS(env67_slpasp, here::here(paste0('Documents\\PHD\\Chp 3\\',surveynum, '_', gridsize, 'km_', loctype2, '_slpasp.rda')))
...
#### SAVE ssh ####
saveRDS(env9_ssh, here::here(paste0('Documents\\PHD\\Chp 3\\',surveynum, '_', gridsize, 'km_', loctype2, '_ssh.rda')))
...
#### SAVE sshsd ####
saveRDS(env10_sshsd, here::here(paste0('Documents\\PHD\\Chp 3\\',surveynum, '_', gridsize, 'km_', loctype2, '_sshsd.rda')))
...
#### SAVE eke ####
saveRDS(env11_eke, here::here(paste0('Documents\\PHD\\Chp 3\\',surveynum, '_', gridsize, 'km_', loctype2, '_eke.rda')))
