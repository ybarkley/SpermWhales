...
SwEnvData <- read.csv('./output/SpermiesWithEnvData_20200531.csv')
...
#pull out encs of outliers in LRbest, then select peak with deepest bathymetry
...
sw.visunloc$UTC <- mdy_hm(sw.visunloc$UTC)
