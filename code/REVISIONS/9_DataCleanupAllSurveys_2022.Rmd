...
env3_godas600[env3_godas600[,14]=='NA'] <- NA  
...
PmEnvTMP = data.frame(env1_sstSORT[, c(1:3, 5:10)], `chla`=env2_chlaSORT[, 9], `temp600`=env3_godasSORT[,14], `wavepow`=env4_ww3SORT[,15], `bath_m`= env5_bathSORT$bath_m, 'd2land'=env8_d2landSORT[,1], `ssh`=env9_sshSORT[,11], `sshsd`=env10_sshsdSORT[,9], `eke`=env9_sshSORT[,16], `d2smt`=env12_d2smtSORT[,1])
