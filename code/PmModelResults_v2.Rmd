...
```{r echo=FALSE, fig.cap='Spatial plots of all dynamic environmental variables tested in the models.', fig.width=8, fig.height=10, fig.align='center'}
## image ####
require(here)
require(knitr)
...
```{r echo=FALSE, eval=FALSE, fig.cap='Temperatures at a depth of 584 m for September 2010.'}
...
```{r echo=FALSE, fig.cap = "Foraging Model 1: Partial effects plots without a spatial smoother, now accounting for temporal variation." , fig.width=6, fig.height=5}
...
Performance metrics were comparable to the Acoustics-Only and Combined models as well (Table 3). 
