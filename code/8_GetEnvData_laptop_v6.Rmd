...
#9. SSH: https://resources.marine.copernicus.eu/?option=com_csw&task=results?option=com_csw&view=details&product_id=GLOBAL_REANALYSIS_PHY_001_030,  180 to -180
...
#10. SSHsd: same as ssh,  180 to -180
...
#11. EKE: same as ssh, using U and V data,  180 to -180
...
##RUN BATHYMETRY FIRST
#Start extraction of Env Data
...
#Edit rows of Bathymetry

#filter for bathymetry that is negative and deeper than 100 m
env5_bathAll <- env5_bath
tmp <- filter(env5_bath, bath_m < -100)
env5_bath=tmp
