...
#for 700 m 
# sw <- readRDS( paste0('output/envData/', surveynum, '_', gridsize, 'km_', loctype2, '_sw.rda' ) )

sw <- readRDS( paste0('output/envData/', gridsize, ' km-', loctype, '/', surveynum, '_', gridsize, 'km_', loctype2, '_sw.rda' ) )
lon = sw$lon
lat = sw$lat
dates = sw$UTC
