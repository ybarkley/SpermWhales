...
require(openxlsx)
nmin_all <- read.xlsx(paste0(here('data'), '/', 'SpermiesBath_20200525.xlsx'), sheet=3)
...
write.csv(pmTidyFinal,  'C:\\Users\\yvers\\Documents\\CHP 3\\SpermWhales\\output/SpermiesFinal_20200525.csv', row.names = F)
```
