...
sw <- readRDS(here::here('output', 'centroids1641_10km.rda'))
...
# bathy_tot <- readRDS('C:\\Users\\yvers\\Documents\\CHP 3\\bathy_tot.rda')
...
# saveRDS(env5_bath, 'E:\\PHD\\1_sperm whales\\ENV DATA\\data_output\\1604_10km_bathy.rda')
saveRDS(env5_bath, here::here('output/data_output', '1641_10km_bathyAll.rda'))
...
# tmp2 <- filter(tmp, bath_m < -100)

env5_bath=tmp
saveRDS(env5_bath, here::here('output/data_output', '1641_10km_bathy.rda'))
...
# dist_slice <-readRDS('C:\\Users\\Yvonne.Barkley\\Chp 3\\data\\dist2land.rda')  #NOAA
...
saveRDS(env8_d2land, here::here('output/data_output', '1303_10km_d2land.rda'))


# saveRDS(env8_d2land, 'E:\\PHD\\1_sperm whales\\ENV DATA\\data_output\\1604_10km_d2land.rda')
```
...
saveRDS(env3_godas600, here::here('output/data_output', '1303_10km_t600.rda'))
...
ww3elapsedmin=proc.time()-ptm 
ww3elapsedmin[3]/60

saveRDS(env4_ww3, here::here('output/data_output', '1641_10km_wavepow.rda'))
...
# slope_aspdf2 <-readRDS('C:\\Users\\yvers\\Documents\\CHP 3\\slope_aspHIdf.rda')
...
saveRDS(env67_slpasp, here::here('output/data_output', '1303_10km_slpasp.rda'))

# saveRDS(env67_slpasp, 'E:\\PHD\\1_sperm whales\\ENV DATA\\data_output\\1604_10km_slpasp_.rda')
```
...
# sshtidya <-readRDS('C:\\Users\\yvers\\Documents\\CHP 3\\ssh_tidy.rda') 
...
saveRDS(env9_ssh, here::here('output/data_output', '1303_10km_ssh.rda'))


# saveRDS(env9_ssh, 'E:\\PHD\\1_sperm whales\\ENV DATA\\data_output\\1604_10km_ssh.rda')
```
...
# sshZtidya <-readRDS('C:\\Users\\yvers\\Documents\\CHP 3\\sshsd_tidy.rda') 
...
saveRDS(env10_sshsd, here::here('output/data_output', '1303_10km_sshsd.rda'))
# saveRDS(env10_sshsd, 'E:\\PHD\\1_sperm whales\\ENV DATA\\data_output\\1604_10km_sshsd.rda')
```
...
ekeZtidya <-readRDS('C:\\Users\\yvers\\Documents\\CHP 3\\eke_tidy.rda') 
...
saveRDS(env11_eke, here::here('output/data_output', '1303_10km_eke.rda'))
# saveRDS(env11_eke, 'E:\\PHD\\1_sperm whales\\ENV DATA\\data_output\\1604_10km_eke.rda')
```
