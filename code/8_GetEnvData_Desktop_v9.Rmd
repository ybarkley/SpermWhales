...
sw <- readRDS( paste0('output/centroids/', gridsize, ' km-', loctype, '/', 'centroids', surveynum, '_', gridsize, 'km_', loctype2, '.rda' ) )

lon = ifelse(sw$lon>180, sw$lon-360, sw$lon)
lat = sw$lat
dates=sw$UTC 

#get the min and max UTC for the dataset
minUTC <- min(sw$UTC)
minUTC <- str_sub(minUTC, 1,10)
minUTC <- ymd_hms(paste0(minUTC, ' 00:00:00'))
maxUTC <- max(sw$UTC)
maxUTC <- str_sub(maxUTC, 1,10)
maxUTC <- ymd_hms(paste0(maxUTC, ' 00:00:00'))
...
sshtidyaTMP <-readRDS('data\\ssh_tidy.rda') #desktop
...
sshZtidyaTMP <-readRDS('data\\sshsd_tidy.rda') #desktop
...
ekeZtidyaTMP <-readRDS('data\\eke_tidy.rda') #desktop
...
#### SAVE All bathy data ####
saveRDS(env5_bath, here::here( paste0('output/envData/',surveynum, '_', gridsize, 'km_', loctype2, '_bathyAll.rda') ))
...
saveRDS(env5_bath, here::here( paste0('output/envData/',surveynum, '_', gridsize, 'km_', loctype2, '_bathy.rda') )) #Desktop
...
#### SAVE d2land ####
saveRDS(env8_d2land, here::here(paste0('output/envData/',surveynum, '_', gridsize, 'km_', loctype2, '_d2land.rda')))
...
#### SAVE temp600 ####
saveRDS(env3_godas600, here::here(paste0('output/envData/',surveynum, '_', gridsize, 'km_', loctype2, '_temp600.rda')))
...
#### SAVE wavepow ####
saveRDS(env4_ww3, here::here(paste0('output/envData/',surveynum, '_', gridsize, 'km_', loctype2, '_wavepow.rda')))
...
#### SAVE slpasp ####
saveRDS(env67_slpasp, here::here(paste0('output/envData/',surveynum, '_', gridsize, 'km_', loctype2, '_slpasp.rda')))
...
#### SAVE ssh ####
saveRDS(env9_ssh, here::here(paste0('output/envData/',surveynum, '_', gridsize, 'km_', loctype2, '_ssh.rda')))
...
#### SAVE sshsd ####
saveRDS(env10_sshsd, here::here(paste0('output/envData/',surveynum, '_', gridsize, 'km_', loctype2, '_sshsd.rda')))
...
#### SAVE eke ####
saveRDS(env11_eke, here::here(paste0('output/envData/',surveynum, '_', gridsize, 'km_', loctype2, '_eke.rda')))


total_min = proc.time()-ptm_total
total_min[3]/60
```
