...
The Pseudorca map will be more colorful. test
...
swdf0$sighted2[swdf0$sighted =="0"]<-"Acoustics Only (n=254)"
...
test <- subset(swdf0, swdf0$sighted2 == 'Acoustics Only (n=254)')
...
png(file = "C:\\Users\\Yvonne\\Documents\\PHD\\CHP2&3-Sperm\\data\\MAPtest_test.png", width = 8, height = 5, res = 200, units = "in")
...
ggplot() +  ## this just makes the background white
  ...
  scale_color_manual(values = c('darkorange','navy','darkviolet'))+
